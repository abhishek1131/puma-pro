      ...
      <div className="flex gap-4 items-start h-16">
        <div className="flex flex-col items-end h-16">
          ...
          >
            ...
            {/* SVG icon */}
            <div
              className="relative z-10 transition-all duration-300 ease-linear
                group-hover:absolute group-hover:left-1/2 
                group-hover:-translate-x-1/2 group-hover:scale-110"
            >
              <svg
                width="24"
                height="25"
              ...
              >
                ...
                <path
                  ...
                  className="transition-all duration-300 ease-linear fill-white group-hover:fill-[url(#arrowGradient)]"
                />
              </svg>
            </div>
