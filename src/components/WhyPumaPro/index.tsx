  ...
  return (
    <article
      className={`flex flex-col justify-center items-center pb-6 bg-white rounded-2xl shadow-md transition-all duration-300 hover:shadow-2xl hover:border-2 hover:border-teal-500 ${
        isNoSubscriptions
          ? "h-[480px] w-[380px] max-md:h-auto max-md:w-full max-md:max-w-[360px] max-sm:max-w-[320px] hover:h-[500px] hover:w-[400px] max-md:hover:h-auto max-md:hover:w-full max-sm:hover:h-auto max-sm:hover:w-full"
          : "h-[436px] w-[380px] max-md:h-auto max-md:w-full max-md:max-w-[360px] max-sm:max-w-[320px] hover:h-[456px] hover:w-[400px] max-md:hover:h-auto max-md:hover:w-full max-sm:hover:h-auto max-sm:hover:w-full"
      }`}
    >
      <img
        src={image}
        ...
        className={`shrink-0 aspect-[1/1] transition-all duration-300 ${
          isNoSubscriptions
            ? "h-[220px] w-[220px] max-md:h-[180px] max-md:w-[180px] max-sm:h-[140px] max-sm:w-[140px] hover:h-[240px] hover:w-[240px] max-md:hover:h-[200px] max-md:hover:w-[200px] max-sm:hover:h-[160px] max-sm:hover:w-[160px]"
            : "h-[200px] w-[200px] max-md:h-[160px] max-md:w-[160px] max-sm:h-[120px] max-sm:w-[120px] hover:h-[220px] hover:w-[220px] max-md:hover:h-[180px] max-md:hover:w-[180px] max-sm:hover:h-[140px] max-sm:hover:w-[140px]"
        }`}
      />
      <div className="flex flex-col shrink-0 gap-3 items-center w-full max-md:gap-2 max-sm:gap-1.5 px-4">
        <header className="flex flex-col items-center w-full transition-all duration-300 hover:translate-y-1 hover:scale-[0.98]">
          <h2
            ...
            style={{
              ...
              backgroundImage: "linear-gradient(90deg, #00C2A0 0%, #0075C3 100%)",
            }}
          >
            {title}
          </h2>
        </header>
        <div className="flex flex-col items-center py-0 max-w-[340px] max-md:max-w-[320px] max-sm:max-w-[280px] transition-all duration-300 hover:translate-y-1 hover:scale-[0.98]">
          <p
            className="w-full text-base leading-5 text-center text-gray-600 max-md:text-sm max-md:leading-4 max-sm:text-xs max-sm:leading-4"
            style={{
              fontFamily: "Inter, sans-serif",
              fontWeight: 400,
              fontSize: "15px",
...
export function GetStartedButton() {
  ...
  return (
    <div className="flex flex-col items-center h-14 w-full max-w-[249px] max-sm:max-w-[300px]">
      <button
...
export function WhyPumaProSection() {
  ...
  return (
    ...
    >
      ...
      <div className="flex relative flex-col gap-10 justify-center items-center mx-auto w-full max-w-screen-xl z-[1] max-md:gap-8 max-md:max-w-[991px] max-sm:gap-6 max-sm:max-w-[640px]">
